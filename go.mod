module github.com/go-anyway/framework-core

go 1.25.4

require (
	github.com/gin-gonic/gin v1.11.0
	github.com/go-anyway/framework-cache v1.0.0
	github.com/go-anyway/framework-clickhouse v1.0.0
	github.com/go-anyway/framework-config v1.0.0
	github.com/go-anyway/framework-configcenter v1.0.0
	github.com/go-anyway/framework-cron v1.0.0
	github.com/go-anyway/framework-db v1.0.0
	github.com/go-anyway/framework-elasticsearch v1.0.0
	github.com/go-anyway/framework-email v1.0.0
	github.com/go-anyway/framework-gateway v1.0.0
	github.com/go-anyway/framework-hotreload v1.0.0
	github.com/go-anyway/framework-interceptor v1.0.0
	github.com/go-anyway/framework-log v1.0.0
	github.com/go-anyway/framework-messagequeue v1.0.0
	github.com/go-anyway/framework-metrics v1.0.0
	github.com/go-anyway/framework-mongodb v1.0.0
	github.com/go-anyway/framework-oss v1.0.0
	github.com/go-anyway/framework-ratelimit v1.0.0
	github.com/go-anyway/framework-trace v1.0.0
	github.com/go-anyway/framework-websocket v1.0.0
	github.com/go-anyway/framework-xxljob v1.0.0
...
require (
	...
	github.com/go-anyway/framework-errors v1.0.0 // indirect
